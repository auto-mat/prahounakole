...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mesto.horni_menu'
        db.add_column('cyklomapa_mesto', 'horni_menu',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Mesto.paticka'
        db.add_column('cyklomapa_mesto', 'paticka',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Mesto.logo'
        db.add_column('cyklomapa_mesto', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mesto.horni_menu'
        db.delete_column('cyklomapa_mesto', 'horni_menu')

        # Deleting field 'Mesto.paticka'
        db.delete_column('cyklomapa_mesto', 'paticka')

        # Deleting field 'Mesto.logo'
        db.delete_column('cyklomapa_mesto', 'logo')
    ...
    models = {
        ...
        'cyklomapa.mesto': {
            ...
            'horni_menu': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            'nazev': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'paticka': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
