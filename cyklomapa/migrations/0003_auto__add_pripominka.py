...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Pripominka'
        db.create_table('cyklomapa_pripominka', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trasa', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('varianta', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='novy', max_length=10)),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('cyklomapa', ['Pripominka'])


    def backwards(self, orm):
        # Deleting model 'Pripominka'
        db.delete_table('cyklomapa_pripominka')
    ...
    models = {
        ...
        'cyklomapa.pripominka': {
            'Meta': {'object_name': 'Pripominka'},
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'novy'", 'max_length': '10'}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'trasa': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'varianta': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        },
        'cyklomapa.status': {
