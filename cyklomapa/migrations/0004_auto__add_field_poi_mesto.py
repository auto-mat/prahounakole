...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poi.mesto'
        db.add_column('cyklomapa_poi', 'mesto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cyklomapa.Mesto']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poi.mesto'
        db.delete_column('cyklomapa_poi', 'mesto_id')
