...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poi.datum_zmeny'
        db.alter_column('cyklomapa_poi', 'datum_zmeny', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Poi.datum_zmeny'
        db.alter_column('cyklomapa_poi', 'datum_zmeny', self.gf('django.db.models.fields.DateTimeField')(auto_now=False))
