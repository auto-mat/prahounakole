...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Mesto'
        db.create_table('cyklomapa_mesto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nazev', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50)),
            ('aktivni', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('vyhledavani', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('zoom', self.gf('django.db.models.fields.PositiveIntegerField')(default=13)),
            ('uvodni_zprava', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('geom', self.gf('django.contrib.gis.db.models.fields.PointField')()),
        ))
        db.send_create_signal('cyklomapa', ['Mesto'])

        # Adding model 'UserMesto'
        db.create_table('cyklomapa_usermesto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('cyklomapa', ['UserMesto'])

        # Adding M2M table for field mesta on 'UserMesto'
        db.create_table('cyklomapa_usermesto_mesta', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('usermesto', models.ForeignKey(orm['cyklomapa.usermesto'], null=False)),
            ('mesto', models.ForeignKey(orm['cyklomapa.mesto'], null=False))
        ))
        db.create_unique('cyklomapa_usermesto_mesta', ['usermesto_id', 'mesto_id'])


    def backwards(self, orm):
        # Deleting model 'Mesto'
        db.delete_table('cyklomapa_mesto')

        # Deleting model 'UserMesto'
        db.delete_table('cyklomapa_usermesto')

        # Removing M2M table for field mesta on 'UserMesto'
        db.delete_table('cyklomapa_usermesto_mesta')
