...
RUN apt-get -qq update; apt-get -y install nodejs gettext libgettextpo-dev libgraphviz-dev libz-dev libjpeg-dev libfreetype6-dev python3-dev gdal-bin 	python3-gdal libgdal-dev python3-numpy locales locales-all cron jq supervisor unrar gawk
