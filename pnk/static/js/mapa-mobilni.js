/*
 * Tento skript závisí na opravě dvou chyb v Openlayers:
 *    http://trac.openlayers.org/ticket/1249
 *    http://trac.openlayers.org/ticket/2892
 */
	   ...
	   if (mapconfig.center_feature) {
        ...
        var createPopup = function(response) {
            ...
            var anchor = {
                'size': new OpenLayers.Size(this.attributes.width/2,this.attributes.height/2),
