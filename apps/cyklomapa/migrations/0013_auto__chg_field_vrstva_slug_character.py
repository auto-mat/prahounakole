...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vrstva.slug_character'
        db.alter_column(u'cyklomapa_vrstva', 'slug_character', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=1))

    def backwards(self, orm):

        # Changing field 'Vrstva.slug_character'
        db.alter_column(u'cyklomapa_vrstva', 'slug_character', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1, null=True))
    ...
    models = {
        ...
        u'cyklomapa.vrstva': {
            ...
            'remark': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '50'}),
            'slug_character': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '1'}),
