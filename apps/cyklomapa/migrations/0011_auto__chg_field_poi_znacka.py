...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cyklomapa_poi', 'znacka_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyklomapa.Znacka']))

    def backwards(self, orm):

        # Changing field 'Poi.znacka'
        db.alter_column(u'cyklomapa_poi', 'znacka_id', self.gf('smart_selects.db_fields.GroupedForeignKey')(to=orm['cyklomapa.Znacka'], group_field='vrstva'))
