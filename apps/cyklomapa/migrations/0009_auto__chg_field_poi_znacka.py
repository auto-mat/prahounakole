...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Poi.znacka'
        db.alter_column('cyklomapa_poi', 'znacka_id', self.gf('smart_selects.db_fields.GroupedForeignKey')(to=orm['cyklomapa.Znacka'], group_field='vrstva'))

    def backwards(self, orm):

        # Changing field 'Poi.znacka'
        db.alter_column('cyklomapa_poi', 'znacka_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cyklomapa.Znacka']))
    ...
    models = {
        ...
        'cyklomapa.poi': {
            ...
            'znacka': ('smart_selects.db_fields.GroupedForeignKey', [], {'to': "orm['cyklomapa.Znacka']", 'group_field': "'vrstva'"})
        },
        'cyklomapa.status': {
