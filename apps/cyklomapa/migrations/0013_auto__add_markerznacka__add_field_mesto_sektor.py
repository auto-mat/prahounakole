...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MarkerZnacka'
        db.create_table(u'cyklomapa_markerznacka', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('marker', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['webmap.Marker'], unique=True, null=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'cyklomapa', ['MarkerZnacka'])

        # Adding field 'Mesto.sektor'
        db.add_column(u'cyklomapa_mesto', 'sektor',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['webmap.Sector'], unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MarkerZnacka'
        db.delete_table(u'cyklomapa_markerznacka')

        # Deleting field 'Mesto.sektor'
        db.delete_column(u'cyklomapa_mesto', 'sektor_id')
